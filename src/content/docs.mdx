...
<NewEditor id="unique"  codeString={`function renderUsername(username) {
...
<NewEditor id="something"   codeString={`// Custom Hook (adopt the TNG hooks-context from showNav())
...
----------
CONTENT AFTER THIS IS GETIFY's
----------
# TNG-Hooks
